...
from interpretDistill.binary_mapper import *
...
def add_main_args(parser):
    ...
    parser.add_argument(
        "--binary_mapper_name", 
        type=str, 
        choices=["gmm_binary_mapper", "dt_binary_mapper"],
        default="gmm_binary_mapper", 
...
if __name__ == "__main__":
    ...
    r['distiller_avg_kfold_val_r2'] = np.mean(scores_[1])
    
    r['teacher_kfold_val_r2'] = scores_[0]
    r['distiller_kfold_val_r2'] = scores_[1]
